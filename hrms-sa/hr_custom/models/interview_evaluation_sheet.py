...
class InterviewEvaluationSheet(models.Model):
    ...
    currency_id = fields.Many2one('res.currency', string="Current Salary Currency")
    ...
    expected_currency_id = fields.Many2one('res.currency', string="Currency")
    expected_basic_salary = fields.Monetary(string="Expected Basic Salary (Per Month)",required=True)
    expected_other_allowances  = fields.Monetary(string="Expected Other Allowances (Per Month) ",required=True)
    expected_annual_incentives = fields.Monetary(string="Expected Annual Incentives",required=True)  
...
class EvaluationLine(models.Model):
    ...
    description  = fields.Text(string="Description",related='attributes.description')
